...
{
    public class SaveToWord:ReportToWord
    {
       ...
       paragraphProperties)
        ...
        protected override void CreateWord(WordInfoConfRoom info)
        {
        ...
        protected override void SaveWord(WordInfoConfRoom info)
        {
        ...
        protected override void CreateWord(WordInfoRoomConf info)
        {
            _wordDocument = WordprocessingDocument.Create(info.FileName,
           WordprocessingDocumentType.Document);
            MainDocumentPart mainPart = _wordDocument.AddMainDocumentPart();
        ...
        protected override void SaveWord(WordInfoRoomConf info)
        {
            _docBody.AppendChild(CreateSectionProperties());
            _wordDocument.MainDocumentPart.Document.Save();
            _wordDocument.Close();
