...
namespace HotelBusinessLogic.BusinessLogic.OfficePackage.Implements
{
    public class SaveToExcel : ReportToExcel
    {
    ...
    "http://schemas.microsoft.com/office/spreadsheetml/2010/11/main");
        ...
        protected override void CreateExcel(ExcelInfoConfRoom info)
        {
        ...
        protected override void CreateExcel(ExcelInfoRoomConf info)
        {
            _spreadsheetDocument = SpreadsheetDocument.Create(info.FileName,
          SpreadsheetDocumentType.Workbook);
            // Создаем книгу (в ней хранятся листы)
        ...
        protected override void SaveExcel(ExcelInfoConfRoom info)
        {
            _spreadsheetDocument.WorkbookPart.Workbook.Save();
            _spreadsheetDocument.Close();
        }

        protected override void SaveExcel(ExcelInfoRoomConf info)
        {
            _spreadsheetDocument.WorkbookPart.Workbook.Save();
            _spreadsheetDocument.Close();
        }
